...
function template_main()
{
	...
	echo '
				...
				<dd>
					...
					<input type="number" name="minage" id="minage" value="', empty($context['search_params']['minage']) ? '0' : $context['search_params']['minage'], '" max="9999">
					<label for="maxage"> ', $txt['search_and'], ' </label>
					<input type="number" name="maxage" id="maxage" value="', empty($context['search_params']['maxage']) ? '9999' : $context['search_params']['maxage'], '" max="10000"> ', $txt['days_word'], '
				</dd>
			</dl>
			<script>
	...
	if (!empty($context['topics'])) {
		echo '
			<div class="search_order">
				...
				<select name="sort" form="new_search" onchange="document.forms.new_search.submit()">
					<option value="relevance|desc">', $txt['search_orderby_relevant_first'], '</option>
