...
function template_pm_popup()
{
	...
	echo '
		<div class="header">
			<a href="', $scripturl, '?action=pm" class="button">
				', $txt['inbox'], '
			</a>
			<div class="options">
				', $context['can_send_pm'] ? '<a href="' . $scripturl . '?action=pm;sa=send" title="' . $txt['pm_new_short'] . '">
					<span class="main_icons newpm"></span>
				</a>' : '', '
				', $context['can_draft'] ? ' <a href="' . $scripturl . '?action=pm;sa=showpmdrafts" title="' . $txt['pm_drafts_short'] . '">
					<span class="main_icons drafts"></span>
				</a>' : '', '
				<a href="', $scripturl, '?action=pm;f=sent" title="', $txt['sent_items'], '">
					<span class="main_icons sent"></span>
				</a>
				<a href="', $scripturl, '?action=pm;sa=settings" title="', $txt['pm_settings_short'], '">
		...
		foreach ($context['unread_pms'] as $id_pm => $pm_details)
			...
			<div class="generic_notification">
				<div class="avatar">
					...
					<span class="main_icons ', $pm_details['replied_to_you'] ? 'replied" title="' . $txt['pm_you_were_replied_to'] . '"' : 'im_off" title="' . $txt['pm_was_sent_to_you'] . '"', '></span>
				</div>
				<div class="details">
					', $pm_details['pm_link'], '
				</div>
