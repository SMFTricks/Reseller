		...
		echo '
					...
					<div id="post_event">
						<fieldset id="event_options">
							...
							<div class="event_option" id="event_title">
								<label for="evtitle">', $txt['calendar_event_title'], '</label>
								<input type="text" id="evtitle" name="evtitle" maxlength="255" value="', $context['event']['title'], '" tabindex="', $context['tabindex']++, '">
							</div>
							<div id="event_time_input">
								<div class="event_start">
									<label for="start_date">', $txt['start_date'], '</label>
									...
									<div>
										<label for="startstart_time_date">', $txt['start_time'], '</label>
								...
								<div class="event_end">
									<label for="end_date">', $txt['end_date'], '</label>
									...
									<div>
										<label for="end_time">', $txt['end_time'], '</label>
							...
							<div id="event_time_options">
								<div id="event_allday" class="event_option">
									<label for="allday">', $txt['calendar_allday'], '</label>
									<input type="checkbox" name="allday" id="allday"', !empty($context['event']['allday']) ? ' checked' : '', ' tabindex="', $context['tabindex']++, '">
								</div>
								<div id="event_timezone" class="event_option">
									<label for="tz">', $txt['calendar_timezone'], '</label>
			...
			echo '
							...
							<div class="event_option">
								<label for="event_location"">', $txt['location'], '</label>
